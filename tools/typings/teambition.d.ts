...
declare module 'teambition' {
  ...
  interface IProjectData extends angular.resource.IResource<any> {
    _id: string;
    name: string;
    logo: string;
    py: string;
  ...
  interface ILinkedData extends angular.resource.IResource<any> {
    _id: string;
    _projectId: string;
    _parentId: string;
    _linkedId: string;
  ...
  interface IEntryData extends angular.resource.IResource<any> {
    _id: string;
    _projectId: string;
    _creatorId: string;
  ...
  interface ITaskData extends angular.resource.IResource<any> {
    _id: string;
    _executorId: string;
    _projectId: string;
    _tasklistId: string;
  ...
  interface IFileData extends angular.resource.IResource<any> {
    _id: string;
    fileName: string;
    fileType: string;
    fileSize: number;
  ...
  interface ICollectionData extends angular.resource.IResource<any> {
    _id: string;
    _parentId: string;
  ...
  interface IPostData extends angular.resource.IResource<any> {
    _id: string;
    postMode: string;
    _creatorId: string;
    _projectId: string;
  ...
  interface IEventData extends angular.resource.IResource<any> {
    _id: string;
    endDate: any;
    startDate: any;
    _projectId: string;
  ...
  interface ITagsData extends angular.resource.IResource<any> {
    _creatorId: string;
    _id: string;
    _projectId: string;
    color: string;
  ...
  interface ITasklistData extends angular.resource.IResource<any> {
    _id: string;
    title: string;
    description: string;
    _projectId: string;
  ...
  interface IActivityData extends angular.resource.IResource<any> {
    _id: string;
    action: string;
    rawAction: string;
    created: number;
  ...
  interface IProjectActivitiesData extends angular.resource.IResource<any> {
    _id: string;
    action: string;
    content: {
      objects: any;
  ...
  interface IOrganizationData extends angular.resource.IResource<any> {
    _id: string;
    name: string;
    _creatorId: string;
    logo: string;
  ...
  interface ISubtaskData extends angular.resource.IResource<any>{
    _id: string;
    _projectId: string;
    _creatorId: string;
    content: string;
